/*
 * Test program for pigpio GPIO backend
 * Uses only the system pigpio library
 */
...
{
    printf("\n=== Enhanced GPIO Direction Tests (pigpio) ===\n");
    double start_time = get_time_ms();
...
{
    printf("\n=== Enhanced GPIO Value Tests (pigpio) ===\n");
    double start_time = get_time_ms();
...
int main(void)
{
    printf("=== pigpio GPIO Test Program ===\n");
    printf("Using system pigpio library\n");
